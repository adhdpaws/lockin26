  ...
  return (
    <SafeAreaView className="flex-1 bg-white" edges={['top']}>
      <View className="px-6 py-4 border-b border-gray-100 z-50 bg-white flex-row justify-between items-center">
        <View>
          <Text className="font-black text-2xl tracking-tighter">WAR ZONE</Text>
          <Text className="font-bold text-[10px] text-gray-400 tracking-[0.2em]">ACHIEVEMENT PHYSICS</Text>
        </View>
